...
import { registerApiTailRoutes } from "./routes-api-tail.mjs";
export function registerCoreRoutes(app, mount) {
  ...
  mount("/api/public/forwarder-lane-quote/:code", () => import("./api/public/forwarder-lane-quote.js")); // 2026-09-05 货代门户按航线收价(RFQ记过程+运价表记结果)
