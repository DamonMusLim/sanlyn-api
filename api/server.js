...
mount("/api/db/product-rebate",    () => import("./api/db/product-rebate.js")); // HS退税率/增值税率 reference + 批量补全(收敛裸SQL)
...
mount("/api/db/workbench-kpi",   () => import("./api/db/workbench-kpi.js"));  // 经营工作台 KPI (workbench)
mount("/api/db/employees",       () => import("./api/db/employees.js"));       // payroll/HR
mount("/api/db/payroll-sheets",  () => import("./api/db/payroll-sheets.js")); // payroll sheets
