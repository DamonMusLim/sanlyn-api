...
// customs_draft sheet API · table: customs_draft_sheets
...
const TABLE = "customs_draft_sheets";
const SHEET_TYPE = "customs_draft";
const ALLOWED_OWNER_FIELDS = ["declaration", "factory_address", "pol", "participant_note", "factory_visible_note", "customs_visible_note"];
const JSONB_COLUMNS = new Set(["declaration"]);
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      const ins = await pool.query("\n        INSERT INTO " + TABLE + "\n          (order_id, order_no, contract_no, owner_company_code, assignee_user, assignee_name,\n           due_at, status, declaration, factory_address, pol)\n        VALUES ($1,$2,$3,$4,$5,$6,$7,'assigned',$8::jsonb,$9,$10)\n        RETURNING *\n      ", [
        ...
        b.factory_address || null, b.pol || null,
      ]);
