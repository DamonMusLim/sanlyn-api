...
export default async function handler(req, res) {
  ...
  try {
    ...
    addSheet(wb, "对账主表", ["PO号", "BL", "ETD", "贸易条款", "货品成本", "货品销售", "海运成本USD", "驳船CNY", "海运销售USD", "港杂销售CNY", "报关额", "缺口"],
      master.map(r => [r.po_nos, r.bl_no, r.etd, r.trade_terms, r.goods_cost, r.goods_sale, r.ocean_cost_usd, r.barge_cost_cny, r.ocean_sale_usd, r.port_sale_cny, r.declared_amount, (r.gap_flags || []).join("/")]));
