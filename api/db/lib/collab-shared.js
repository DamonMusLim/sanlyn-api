...
const COLLAB_VERSION = "v2026.08.26-1";
const COLLAB_VERSION_AT = "2026-08-26T00:00+00:00";
const COLLAB_CHANGELOG = [
  { v: "v2026.08.26-1", at: "2026-08-26", note: "supplier_portal 海运段按承运方实际承担段派生：非本票货代一律物理删除船名/航次/SO/货代身份/海运费；字段档同步按段合成，不再无条件落 carrier 档" },
