...
//   3) exchange_rates table latest USD_CNY + 0.10
//   4) Hard fallback 7.30
//
...
async function resolveFx(pool, orderRows, fdnRows) {
  ...
  // 3) exchange_rates table (latest, may auto-refresh elsewhere)
  try {
  ...
  return { rate: FALLBACK_FX, source: "fallback", base: FALLBACK_FX - DEFAULT_FX_MARKUP };
}
