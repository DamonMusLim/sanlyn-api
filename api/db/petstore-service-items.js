...
async function createItem(req, res, body, storeCode) {
  ...
  const { rows } = await pool.query(
    `INSERT INTO service_items (
       ...
       note, image_url, member_price, is_mini_program_enabled, other_status, service_description, updated_at
     ) VALUES (
