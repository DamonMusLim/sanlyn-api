...
// certificate_application sheet API · table: cert_application_sheets
...
const TABLE = "cert_application_sheets";
const SHEET_TYPE = "certificate_application";
const ALLOWED_OWNER_FIELDS = ["cert_country", "cert_type", "application_data", "participant_note", "factory_visible_note"];
const JSONB_COLUMNS = new Set(["application_data"]);
