...
var ALLOWED_TABLES = {
  orders: { label: "订单管理", key: "_id", columns: ["_id","order_no","contract_no","customer_po","customer","company_code","seller_code","purchase_trade_terms","terms_model_version","shipping_plan_id","issuing_company_id","customer_company_id","factory_company_id","seller_company_id","company_name_cn","company_name_en","consignee","customer_address","country","destination_port","pol","delivery_date","confirmed_delivery","required_arrival","total_qty","total_cbm","gross_weight","net_weight","container_type","container_qty","total_amount","total_amount_factory","currency","exchange_rate","profit","declare_amount","tax_rebate_amount","trade_terms","status","production_status","factory","remarks","created_at","updated_at"] },
