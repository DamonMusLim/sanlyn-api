...
var ALLOWED_TABLES = {
  ...
  shipping_plans: { label: "海运计划", key: "_id", columns: ["_id","shipment_no","so_no","bl_no","vessel","voyage","shipping_line","transit","schedule","call_port","pol","pod","container_type","container_qty","container_no","cutoff_date","si_cutoff_date","port_open_date","shipment_date","etd","atd","eta","ata","customer","customer_en","customer_cn","order_nos","contract_nos","forwarder_cn","forwarder_en","trucking_cn","customs_cn","insurance_cn","freight_cost","freight_sale_usd","doc_fee","tlx_fee","info_trans_fee","bkg_fee","thc_fee","eir_fee","seal_fee","freight_total_usd","freight_total_cny","trucking_cost_total","customs_cost_total","insurance_cost","is_ddp","ddp_total","ddp_agent","flow_status","status","current_status","current_status_cn","remarks","created_at","updated_at"] },
