...
// inspection_request sheet API · table: inspection_request_sheets
...
const TABLE = "inspection_request_sheets";
const SHEET_TYPE = "inspection_request";
const ALLOWED_OWNER_FIELDS = ["inspection", "requested_certs", "participant_note", "factory_visible_note", "customs_visible_note"];
const JSONB_COLUMNS = new Set(["inspection"]);
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      const ins = await pool.query("\n        INSERT INTO " + TABLE + "\n          (order_id, order_no, contract_no, owner_company_code, assignee_user, assignee_name,\n           due_at, status, inspection, requested_certs)\n        VALUES ($1,$2,$3,$4,$5,$6,$7,'assigned',$8::jsonb,$9::text[])\n        RETURNING *\n      ", [
        ...
        Array.isArray(b.requested_certs) ? b.requested_certs : [],
      ]);
