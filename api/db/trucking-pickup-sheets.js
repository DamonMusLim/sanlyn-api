...
// trucking_pickup_confirmation sheet API · table: trucking_pickup_sheets
...
const TABLE = "trucking_pickup_sheets";
const SHEET_TYPE = "trucking_pickup_confirmation";
const ALLOWED_OWNER_FIELDS = ["pickup", "participant_note", "forwarder_visible_note", "factory_visible_note"];
const JSONB_COLUMNS = new Set(["pickup"]);
