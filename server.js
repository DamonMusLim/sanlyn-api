...
mount("/api/db/seller-profiles",   () => import("./api/db/seller-profiles.js")); // issuing company list for SELLER dropdown
...
mount("/api/db/migrate-brand-permissions",  () => import("./api/db/migrate-brand-permissions.js")); // company_brand_permissions table
mount("/api/db/brand-permissions",          () => import("./api/db/brand-permissions.js"));         // CRUD: admin brand visibility per customer
