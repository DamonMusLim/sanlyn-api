...
var KNOWN_REAL_PATHS=[
  "/wb","/wb-tabs","/ocean","/rates","/ship-grid","/ship-entry","/manifest","/manifest-cfg","/kb",
...
var BUILT={
  "工作台":"/wb","运价管理":"/rates","海运出口":"/ship-grid",
  "上海-舱单发送":"/manifest","账单管理":"/ocean","审核提交记录":"/ops-todos"
};
var NAV=[
  n("工作台"),n("运价管理"),n("智能邮箱"),
  n("报价管理",["单票报价","费用模板"]),
  n("集运订单",["待接单","海运出口","海运进口","空运出口","空运进口","物流园报关","陆运","铁路运输","内贸水运","自拼"]),
