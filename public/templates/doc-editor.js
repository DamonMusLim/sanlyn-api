...
function setDefaultTerms(){
  ...
  el.innerText='1. PACKING Export seaworthy cartons + inner packaging per approved spec sheet & sealed samples. Buyer approves all artwork before production. Claims inconsistent with approved specs rejected.\n2. SHIPMENT Within 30 days of receipt of deposit AND written confirmation of all specifications. Delays caused by Buyer toll the shipment clock.\n3. L or telex release / delivery instruction. Title retained until full payment. Overdue bank lending rate interest.\n4. BV report + batch records. Liability capped at invoice value of defective portion only. Post-resale, moisture, import compliance excluded.\n5. FORCE MAJEURE Includes port congestion, vessel cancellation, raw material shortage, policy changes. If exceeding 60 days, either party may cancel without liability.\n6. ORDER OF PRECEDENCE PI > SC > IV. Buyer own terms do not apply.\n7. IMPORT COMPLIANCE Buyer solely responsible for destination country labeling, registration, permits and import duties.\n8. LIABILITY CAP Maximum liability equals invoice value of affected goods only. No indirect or consequential damages.\n9. DISPUTES Chinese law, CISG excluded. CIETAC Beijing. English language. Loser pays all costs.';
}
