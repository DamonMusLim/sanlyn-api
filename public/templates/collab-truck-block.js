(function(){
  ...
  function injectStyle(){
    ...
    style.textContent = `
.ctb .card{background:#fff;border-radius:10px;border:1px solid #e0e4ea;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.06);margin-bottom:14px}
...
.ctb .form-label{font-size:11px;font-weight:700;color:#374151;margin-bottom:4px;display:block}.ctb .form-label .req{color:#dc2626}
.ctb .form-input{width:100%;border:1.5px solid #c8cdd6;border-radius:6px;padding:8px 10px;font-size:13px;outline:none;font-family:inherit;background:#fff;color:#111}
...
.ctb .btn{padding:7px 16px;border-radius:7px;border:none;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit}.ctb .btn-green{background:#059669;color:#fff}.ctb .btn-ghost{background:#f3f4f6;color:#374151;border:1px solid #e0e4ea}.ctb .btn-sm{padding:5px 12px;font-size:11px}.ctb .btn:disabled{opacity:.5;cursor:not-allowed}
.ctb .badge{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:800}.ctb .badge-red{background:#fee2e2;color:#b91c1c;border:1px solid #fca5a5}
.ctb .step-card{background:#fff;border-radius:10px;border:1px solid #e0e4ea;margin-bottom:14px;overflow:hidden;transition:border-color .2s}.ctb .step-card.required{border-color:#fbbf24}.ctb .step-card.done{border-color:#86efac}
.ctb .step-head{padding:12px 16px;display:flex;align-items:center;justify-content:space-between;background:#fff;border-bottom:1px solid #f0f2f5;transition:background .15s;user-select:none}.ctb .step-card.done .step-head{cursor:pointer}.ctb .step-card.done .step-head:hover{background:#f8fafc}
...
.ctb .step-title{font-size:13px;font-weight:800;color:#1a1d23}.ctb .step-sub{font-size:11px;color:#6b7280;margin-top:1px}.ctb .step-summary{display:none;font-size:11px;font-weight:700;color:#059669;flex:1;margin:0 10px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ctb .step-card.done .step-summary{display:block}.ctb .step-card.done .step-title{font-size:12px;color:#6b7280;font-weight:600}.ctb .step-card.done .step-sub{display:none}
.ctb .chevron{font-size:12px;color:#9ca3af;transition:transform .25s;flex-shrink:0}.ctb .step-card.done .chevron{transform:rotate(0deg)}.ctb .step-card:not(.done) .chevron{transform:rotate(180deg)}.ctb .step-body{overflow:hidden;transition:max-height .3s ease,opacity .3s ease}.ctb .step-card.done .step-body{max-height:0!important;opacity:0}.ctb .step-card:not(.done) .step-body{max-height:2000px;opacity:1}
.ctb .ctn-group{border:1.5px solid #e0e4ea;border-radius:8px;margin-bottom:10px;overflow:hidden}.ctb .ctn-group-head{background:#f8fafc;padding:7px 12px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #e0e4ea}.ctb .ctn-group-title{font-size:11px;font-weight:800;color:#374151}
.ctb .chip{background:#fff;border:1px solid #e0e4ea;border-radius:8px;padding:8px 14px;font-size:12px}.ctb .chip b{color:#1a1d23}.ctb .chip span{color:#6b7280}.ctb .qty-btn{border:1px solid #c8cdd6;background:#fff;border-radius:5px;width:24px;height:24px;font-weight:800;cursor:pointer}.ctb .qty-in{width:42px;border:1px solid #c8cdd6;border-radius:5px;padding:4px;text-align:center;font-weight:800}
.ctb .photo-grid{display:flex;flex-wrap:wrap;gap:6px;padding:8px;background:#fafafa;border:1px solid #eef2f7;border-radius:8px}.ctb .photo-cell{position:relative;width:58px;height:58px;border-radius:6px;overflow:hidden;border:1px solid #e0e4ea;background:#f1f5f9;display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;font-size:10px;color:#64748b;text-align:center}.ctb .photo-cell img{width:100%;height:100%;object-fit:cover}.ctb .photo-cell.add{border-style:dashed;border-color:#cbd5e1}.ctb .photo-cell .del-btn{position:absolute;top:1px;right:1px;width:16px;height:16px;background:#dc2626;color:#fff;border-radius:50%;font-size:11px;font-weight:800;line-height:16px}
.ctb .save-status{text-align:center;font-size:11px;color:#9ca3af;margin:8px 0 14px}@media(max-width:480px){.ctb .grid2,.ctb .veh-grid{grid-template-columns:1fr!important}}
`;
  ...
  function vehHtml(i,d={}){
    ...
    return `<div class="ctn-group" id="veh_${i}"><div class="ctn-group-head"><div class="ctn-group-title">🚛 车 ${i+1}</div>${state.vehs.length > 1 ? `<span style="cursor:pointer;color:#dc2626;font-size:11px;font-weight:700;" onclick="CollabTruckBlock.delVeh(${i})">× 删除</span>` : ""}</div>
