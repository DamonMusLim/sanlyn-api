...
`;
  ...
  function vehHtml(i,d={}){
    ...
    <div class="veh-grid" style="padding:12px;display:grid;grid-template-columns:1fr 1fr;gap:10px;">
      ...
      <div class="form-field" style="margin:0;"><label class="form-label">工厂提货地址</label><div style="font-size:10.5px;color:${addr ? "var(--sub,#64748b)" : "var(--faint,#94a3b8)"};margin-bottom:4px;">📍 ${esc(addr || "提货地址待补")}</div><input class="form-input" id="loadaddr_${i}" value="${esc(addr)}" placeholder="📍 提货地址待补"></div>
      <div class="form-field" style="margin:0;"><label class="form-label">工厂联系人</label><div style="font-size:10.5px;color:${contact ? "var(--sub,#64748b)" : "var(--faint,#94a3b8)"};margin-bottom:4px;">厂内联系人：${esc(contact || "待补")}</div><input class="form-input" id="loadcontact_${i}" value="${esc(contact)}" placeholder="厂内联系人待补"></div>
