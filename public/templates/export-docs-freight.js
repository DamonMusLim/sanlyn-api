(function(){
  ...
  function render(d){
    ...
    var warn=d.used_fallback_card?'<div class="warn-card">系统未查到该票真实账单明细，以下为标准参考费率估算，非实际账单数据，出单前请人工核实真实费用！<br>NOT ACTUAL BILLED CHARGES — verify against real supplier invoice before issuing.</div>':'';
