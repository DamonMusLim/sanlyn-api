...
.ioTop{display:grid;grid-template-columns:110px 1fr 230px;gap:12px;align-items:start;margin-bottom:10px}.ioQr{width:96px;height:96px;border:1px solid #b91c1c;background:#fff}
...
.ioTable{width:100%;border-collapse:collapse;min-width:920px;table-layout:fixed}.ioTable th,.ioTable td{border-bottom:1px solid #efb5b5;border-right:1px solid #f3caca;padding:7px 8px;font-size:13px;text-align:left;vertical-align:middle}
...
@media(max-width:760px){.ioTop{grid-template-columns:98px 1fr}.ioSeal{display:none}.ioMeta{grid-column:1/3}.ioPartyWrap{grid-template-columns:1fr}.ioParty+.ioParty{border-left:0;border-top:1px solid #efb5b5}.ioGrand{grid-template-columns:1fr}.ioGrandSmall{border-left:0;border-top:1px solid #efb5b5}}`;
  ...
  function render(d){
    ...
    return `<div class="invoiceOfficial" data-io-index="${esc(d.index??0)}">
      ...
      <div class="ioTop"><div class="ioQr"></div><div class="ioSeal">国家税务总局<br>监制</div><div class="ioMeta"><div class="ioMetaLine"><span>发票号码：</span>${metaField(meta,"invoice_no","开票时生成",editableMeta)}</div><div class="ioMetaLine"><span>开票日期：</span>${metaField(meta,"issue_date","开票时生成",editableMeta,"date")}</div></div></div>
