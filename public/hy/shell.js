...
var DEDICATED={
  ...
  "集运订单/陆运":"/trucking-rates",
  "报关/箱货/仓储/订舱平台":"/booking-platform",
  "提单管理":"/bl-management",
  "报关/箱货/仓储/在线报关":"/online-customs",
  "报关/箱货/仓储/报关信息":"/manifest",
  "自定义导航":"/custom-nav",
  "报关/箱货/仓储/箱货信息":"/cargo-info",
  "报关/箱货/仓储/仓储信息":"/warehouse-info",
  "报关/箱货/仓储/盯箱宝":"/container-watch",
  "报关/箱货/仓储/全程货物跟踪":"/shipment-tracking",
  "报关/箱货/仓储/SPOT电商":"/spot-ecommerce",
  ...
  "费用管理/集运费用明细":"/consolidated-fee-details",
  "费用管理/开票记录":"/invoice-records",
  "费用管理/收付管理":"/receipt-payment-management",
  "费用管理/核销管理":"/settlement-management",
  "费用管理/提成管理":"/commission-management",
  "报表中心/业务报表":"/business-report",
  "报表中心/财务报表":"/financial-report"
};
var MODULE_MAP={
  "运价管理":"freight_rates",
