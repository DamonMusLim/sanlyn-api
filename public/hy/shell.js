...
var MODULE_MAP={
  ...
  // 2026-09-05 Damon:「hy 差没有付款的账单UI界面,显示公司名」
  // v_payable_by_supplier 按文本分组导致一家变多家(万汇5种写法/洋宝宝3种,144"供应商"实为40家),
  // v_hy_unpaid_bills 做了名称归一 + 带公司码 + 我方主体单独标性质。
  "费用管理/未付款账单":"v_hy_unpaid_bills",
